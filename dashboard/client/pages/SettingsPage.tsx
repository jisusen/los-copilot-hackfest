  ...
  return (
    <div className="app">
      ...
      <div className="app-main" style={{ overflow: "auto" }}>
        <div
          style={{ maxWidth: 720, margin: "0 auto", padding: "24px 24px 48px" }}
        >
          <div
            style={{
              display: "flex",
          ...
          {loading ? (
            ...
            <>
                ...
                {settings.llmProvider === "custom" && (
                  <>
                    ...
                    <Field
                      ...
                      onChange={(v) => update("customApiKey", v)}
                      password
                    />
                    <div
                      style={{
                    ...
                    >
                      Any OpenAI-compatible endpoint works (OpenRouter, Ollama,
                      vLLM, etc.). The chat API must support{" "}
                      <code>/chat/completions</code> with streaming.
                    </div>
                  </>
                )}
              </Section>
              ...
              <Section title="LOS Connection">
                ...
                >
                  The login page path is used by the browser agent to navigate
                  to the LOS login screen. Default is <code>/login</code>.
                </div>
              </Section>
