    ...
    <div data-testid="tab-content-aml-fraud">
      ...
      <div className="mb-6 p-4 rounded-lg border" style={{ background: '#f9fafb', borderColor: '#d1d9e0' }}>
        <div className="flex items-center justify-between">
          <div>
            <span className="text-xs text-muted font-medium uppercase tracking-wide">AML Screening Score</span>
            <div className="text-2xl font-bold font-mono mt-1" style={{ color: vc.text }}>
              {aml.overall_aml_score}
            </div>
          </div>
          <div className="text-right">
            <span className="text-xs text-muted font-medium uppercase tracking-wide">Verdict</span>
          ...
          <div className="text-right">
            <span className="text-xs text-muted font-medium uppercase tracking-wide">Screening Ref</span>
      ...
      <div className="grid grid-cols-2 gap-5 mb-6">
        <div className="bg-white border border-border rounded-lg">
          <h3 className="font-display font-semibold text-text text-sm uppercase tracking-wide px-5 pt-4 pb-2" style={{ borderBottom: '1px solid #e5e7eb' }}>DTTOT Screening</h3>
          <div className="px-5">
        ...
        <div className="bg-white border border-border rounded-lg">
          <h3 className="font-display font-semibold text-text text-sm uppercase tracking-wide px-5 pt-4 pb-2" style={{ borderBottom: '1px solid #e5e7eb' }}>UN Sanctions Screening</h3>
          <div className="px-5">
      ...
      <div className="bg-white border border-border rounded-lg px-5 mb-6">
        <h3 className="font-display font-semibold text-text text-sm uppercase tracking-wide pt-4 pb-2" style={{ borderBottom: '1px solid #e5e7eb' }}>PEP Screening</h3>
      ...
      <div className="grid grid-cols-2 gap-5 mb-6">
        <div className="bg-white border border-border rounded-lg px-5">
          <h3 className="font-display font-semibold text-text text-sm uppercase tracking-wide pt-4 pb-2" style={{ borderBottom: '1px solid #e5e7eb' }}>Adverse Media</h3>
          ...
          {aml.adverse_media_match ? (
            <>
              ...
              <Field label="Details" testId="adverse-media-detail" children={<span className="text-danger">{aml.adverse_media_details}</span>} />
            </>
          ) : null}
        ...
        <div className="bg-white border border-border rounded-lg px-5">
          <h3 className="font-display font-semibold text-text text-sm uppercase tracking-wide pt-4 pb-2" style={{ borderBottom: '1px solid #e5e7eb' }}>Transaction Behavior</h3>
      ...
      <div className="grid grid-cols-2 gap-5 mb-6">
        <div className="bg-white border border-border rounded-lg px-5">
          <h3 className="font-display font-semibold text-text text-sm uppercase tracking-wide pt-4 pb-2" style={{ borderBottom: '1px solid #e5e7eb' }}>EDD Status</h3>
        ...
        <div className="bg-white border border-border rounded-lg px-5">
          <h3 className="font-display font-semibold text-text text-sm uppercase tracking-wide pt-4 pb-2" style={{ borderBottom: '1px solid #e5e7eb' }}>Review</h3>
