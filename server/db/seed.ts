...
const APPS: SeedApp[] = [
  {
    ...
    crde_rules: [],
    crde_notes:
      "Application meets all RAC criteria. DTI within limit, good collectability, no AML flags.",
  ...
  },
  {
    ...
    status: "Under Review",
    created_at: "2026-04-16T09:15:00",
    gross: 10_000_000,
    net: 8_200_000,
    ...
    slik_notes:
      "Debtor consistently pays credit card installments on time over the past 24 months.",
    aml_pep: 0,
    aml_pep_detail: "",
    aml_dttot: 0,
    aml_un: 0,
    ...
    crde_score: 791,
    crde_rules: [
      "DTI 42.1% slightly exceeds KTA limit (40%) — within override tolerance",
    ],
    crde_notes:
      "DTI slightly above threshold but within tolerance. Good collectability. Approved with notes.",
    collateral_required: 0,
    collateral_type: null,
    collateral_desc: null,
    collateral_market: null,
  ...
  },
  {
    ...
    dti_threshold: 0.4,
    verified_docs:
      "Civil Servant Appointment Decree + Payslip + Salary Certificate",
    slik_kol: 1,
    slik_kol_label: "Current",
    slik_worst_12m: 1,
    ...
    aml_fraud_signals: "",
    aml_notes:
      "AML screening passed. Civil servant profile — not a PEP, no risk indicators.",
    crde_risk: "LOW",
    crde_decision: "APPROVED",
    crde_score: 823,
    crde_rules: [],
    crde_notes:
      "Civil servant with stable income. DTI within limit, excellent collectability, no AML/fraud flags.",
    collateral_required: 1,
    collateral_type: "SHM",
    collateral_desc:
      "2-storey residential house, land 120m², building 200m², prime location Jakarta Pusat",
    collateral_market: 1_200_000_000,
    collateral_liquid: 960_000_000,
    collateral_appraisal: "2026-04-10",
    collateral_ltv: 0.417,
    collateral_ltv_threshold: 0.8,
    collateral_cert: "SHM-78901/JKT-PST",
    collateral_legal: "Clear",
    collateral_notes:
      "Collateral in excellent condition, marketable, prime location. LTV well below limit.",
  },
  {
    id: "APP-004",
    ...
    slik_notes:
      "Debtor has a history of late payments. Collectability 2 (Special Mention).",
    aml_pep: 0,
    aml_pep_detail: "",
    aml_dttot: 0,
    aml_un: 0,
    ...
    crde_notes:
      "Two risk factors identified: DTI above threshold and Special Mention collectability. Credit committee review required for final decision.",
    collateral_required: 0,
    collateral_type: null,
    collateral_desc: null,
    collateral_market: null,
  ...
  },
  {
    ...
    crde_rules: [],
    crde_notes:
      "Senior employee with long tenure. DTI within limit, good collectability, low risk profile.",
    collateral_required: 1,
    ...
    collateral_appraisal: "2026-04-12",
    collateral_ltv: 0.8,
    collateral_ltv_threshold: 0.85,
    collateral_cert: "BPKB-B1234XYZ",
    collateral_legal: "Clear",
    collateral_notes:
      "Brand new 2024 vehicle, excellent condition. LTV consistent with KKB RAC.",
  },
  {
    id: "APP-006",
    ...
    crde_rules: [],
    crde_notes:
      "Excellent risk profile. Low DTI, no existing obligations, good collectability. Approved.",
    collateral_required: 0,
    collateral_type: null,
    collateral_desc: null,
    collateral_market: null,
  ...
  },
  {
    ...
    status: "Under Review",
    created_at: "2026-04-12T13:30:00",
    gross: 15_000_000,
    net: 12_000_000,
    ...
    slik_notes:
      "Collectability 3 (Substandard). Significant late payment history. High default risk.",
    aml_pep: 0,
    aml_pep_detail: "",
    aml_dttot: 0,
    aml_un: 0,
    ...
    crde_notes:
      "Very high risk profile. DTI 67% far exceeds threshold. Collectability 3 indicates repeated defaults. Application rejected.",
    collateral_required: 0,
    collateral_type: null,
    collateral_desc: null,
    collateral_market: null,
  ...
  },
  {
    ...
    dti_threshold: 0.4,
    verified_docs:
      "2-Year Financial Statements + 6-Month Bank Statement + Business License + Company Deed",
    slik_kol: 2,
    slik_kol_label: "Special Mention",
    slik_worst_12m: 2,
    ...
    slik_notes:
      "Collectability 2 (Special Mention). Self-employed with variable cash flow.",
    aml_pep: 1,
    aml_pep_detail:
      "Debtor's husband (Mr. Kurniawan Saputra) is a former Eselon II official at Ministry of SOEs, 2018-2022",
    aml_dttot: 0,
    aml_un: 0,
    aml_income_consistent: 1,
    aml_address_flag: 0,
    aml_fraud_signals: "",
    aml_notes:
      "ALERT: Debtor identified as PEP (Politically Exposed Person) through family connection. Manual review required per PPATK regulations.",
    crde_risk: "MEDIUM",
    crde_decision: "COMMITTEE REVIEW",
    crde_score: 589,
    crde_rules: [
    ...
    crde_notes:
      "Three risk factors: DTI above threshold, Special Mention collectability, and PEP flag. Enhanced Due Diligence required before final decision.",
    collateral_required: 1,
    collateral_type: "SHM",
    collateral_desc:
      "3-storey shophouse in Kemang area, land 60m², building 180m²",
    collateral_market: 3_500_000_000,
    collateral_liquid: 2_800_000_000,
    collateral_appraisal: "2026-04-14",
    collateral_ltv: 0.057,
    collateral_ltv_threshold: 0.7,
    collateral_cert: "SHM-34567/JKT-SEL",
    collateral_legal: "Clear",
    collateral_notes:
      "Premium commercial property in Kemang. Market value far exceeds loan amount. Very low LTV.",
  },
  {
    id: "APP-009",
    ...
    dti_threshold: 0.4,
    verified_docs:
      "Civil Servant Decree + Payslip + Salary Declaration + 3-Month Bank Statement",
    slik_kol: 1,
    slik_kol_label: "Current",
    slik_worst_12m: 1,
    slik_history_24m:
      "Excellent — no late payments, 20-year credit track record",
    ...
    aml_fraud_signals: "",
    aml_notes:
      "AML screening passed. Senior civil servant, not identified as high-level PEP. No risk indicators.",
    crde_risk: "LOW",
    crde_decision: "APPROVED",
    crde_score: 835,
    crde_rules: [],
    crde_notes:
      "Senior civil servant with 20-year credit track record. Stable income, good DTI, excellent collectability. Approved.",
    collateral_required: 1,
    collateral_type: "SHM",
    collateral_desc:
      "2-storey luxury house, land 400m², building 500m², premium location Darmo Surabaya",
    collateral_market: 4_000_000_000,
    collateral_liquid: 3_200_000_000,
    collateral_appraisal: "2026-04-08",
    collateral_ltv: 0.2,
    collateral_ltv_threshold: 0.8,
    collateral_cert: "SHM-56789/SBY",
    collateral_legal: "Clear",
    collateral_notes:
      "Premium property in Darmo area. Collateral value far exceeds loan amount. Very low LTV, minimal risk.",
  },
  {
    id: "APP-010",
    ...
    slik_notes:
      "Collectability 2 (Special Mention). Multiple credit lines with repeated late payments.",
    aml_pep: 0,
    aml_pep_detail: "",
    aml_dttot: 0,
    aml_un: 0,
    ...
    aml_address_flag: 1,
    aml_fraud_signals:
      "Income inconsistency: payslip shows IDR 8,000,000 but bank transaction patterns are inconsistent; Loan purpose for crypto investment — high risk category",
    aml_notes:
      "ALERT: Fraud signals detected. Inconsistency between payslip and bank transaction patterns. Reported income does not match transaction evidence. High-risk loan purpose.",
    crde_risk: "HIGH",
    crde_decision: "REJECTED",
    crde_score: 298,
    crde_rules: [
    ...
    crde_notes:
      "Very high risk profile. Five risk factors identified. DTI 73%, Special Mention collectability, and income fraud signals. Application rejected.",
    collateral_required: 0,
    collateral_type: null,
    collateral_desc: null,
    collateral_market: null,
...
export function resetAndSeed(reset = false) {
  ...
  const existing = db
    .query("SELECT COUNT(*) as c FROM loan_applications")
    .get() as { c: number };
  if (!reset && existing.c > 0) {
    console.log(
      `ℹ️  Database already has ${existing.c} applications. Skipping seed. Use --reset to reseed.`,
    );
    return;
  }
  ...
  const SCREENING_DATE = "2026-04-18";
  ...
  for (const app of APPS) {
    ...
    const fraud_passed =
      app.aml_income_consistent === 1 && app.aml_address_flag === 0 ? 1 : 0;
    ...
    insertAudit.run({
      ...
      $action: "AML_SCREENED",
      $detail: app.aml_pep
        ? "PEP flag identified — enhanced due diligence required"
    ...
    console.log(
      `  ✅ ${app.id} — ${app.debtor_name} (${app.product} ${formatRp(app.amount)}) → ${app.crde_decision}`,
    );
  }
